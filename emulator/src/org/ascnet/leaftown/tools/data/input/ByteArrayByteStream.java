 ...
 * @since Revision 326
 */
public final class ByteArrayByteStream implements SeekableInputStreamBytestream {
     ...
     *
     * @see org.ascnet.leaftown.tools.data.input.SeekableInputStreamBytestream#getPosition()
     */
    @Override
     ...
     * @see org.ascnet.leaftown.tools.data.input.SeekableInputStreamBytestream#seek(long)
     */
    @Override
     ...
     *
     * @see org.ascnet.leaftown.tools.data.input.ByteInputStream#readByte()
     */
    @Override
    public int readByte() {
        bytesRead++;
    ...
    public String toString() {
        String nows = "";
        if (arr.length - pos > 0) {
            final byte[] now = new byte[arr.length - pos];
