...
package org.ascnet.leaftown.provider;

import org.ascnet.leaftown.provider.nx.NXDataProvider;
...
public class MapleDataProviderFactory {
    ...
    private final static Path nxPath = Paths.get(System.getProperty("org.ascnet.leaftown.nxpath")).toAbsolutePath();

    public static MapleDataProvider getDataProvider(String name) {
        try {
