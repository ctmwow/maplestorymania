...
public class PlayerCommands implements Command {
	...
	public void execute(MapleClient c, MessageCallback mc, String[] splitted) throws Exception {
		...
		if (splitted[0].equalsIgnoreCase("@str")) {
			...
			mc.dropMessage("Use @help to access the list of player commands for Leaftown.");
			...
			if (splitted.length < 2) {
                ...
                switch (splitted[1]) {
                    ...
                    case "2":
                        ...
                        mc.dropMessage("@gmlist lists all official GMs of Leaftown.");
                    ...
                    case "3":
                        ...
                        break;
                    default:
                        mc.dropMessage("Invalid page number. Use @help <pagenumber> to use the help - there are 3 pages.");
                        break;
                }
			}
		} else if (splitted[0].equalsIgnoreCase("@gmlist")) {
			mc.dropMessage("Leaftown GMs: " + c.getChannelServer().getGMList());
	...
	public CommandDefinition[] getDefinition() {
		return new CommandDefinition[]{
				...
				new CommandDefinition("gmlist", "", "Lists current Leaftown GMs.", 0),
