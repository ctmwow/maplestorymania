        ...
        if (splitted[0].equals("!spy")) {
            ...
            if (splitted.length < 4) {
                ...
                if (type == 1 || type == 2 || type == 4) {
                    ...
                    victim1.getCashShop().gainCash(type, points);
            ...
            Runnable rpass = new Runnable() {

                public void run() {
                    mc.dropMessage(victim.getName() + " has passed confirmation.");
                }
            };
            Runnable rfail = new Runnable() {

                public void run() {
                    mc.dropMessage(victim.getName() + " has failed confirmation.");
                }
            };
