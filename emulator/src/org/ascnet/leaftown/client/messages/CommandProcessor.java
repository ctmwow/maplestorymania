...
import org.ascnet.leaftown.client.messages.commands.HelpCommand;
...
import org.ascnet.leaftown.tools.ClassFinder;
...
public class CommandProcessor implements CommandProcessorMBean {
    ...
    public static void registerMBean() {
        ...
        try {
            mBeanServer.registerMBean(instance, new ObjectName("org.ascnet.leaftown.client.messages:name=CommandProcessor"));
        } catch (Exception e) {
    ...
    public void reloadCommands() {
        ...
        try {
            ...
            String[] classes = classFinder.listClasses("org.ascnet.leaftown.client.messages.commands", true);
