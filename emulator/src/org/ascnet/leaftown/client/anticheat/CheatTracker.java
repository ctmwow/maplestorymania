...
public class CheatTracker {
    ...
    private final Map<CheatingOffense, CheatingOffenseEntry> offenses = Collections.synchronizedMap(new EnumMap<CheatingOffense, CheatingOffenseEntry>(CheatingOffense.class));
