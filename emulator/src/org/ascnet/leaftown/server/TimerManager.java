...
public class TimerManager implements TimerManagerMBean {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TimerManager.class);
    ...
    private TimerManager() {
        ...
        try {
            mBeanServer.registerMBean(this, new ObjectName("org.ascnet.leaftown.server:type=TimerManger"));
        } catch (Exception e) {
