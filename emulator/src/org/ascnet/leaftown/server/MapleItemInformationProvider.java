...
import org.ascnet.leaftown.client.MapleWeaponType;
import org.ascnet.leaftown.client.SkillFactory;
import org.ascnet.leaftown.net.channel.handler.FishingHandler.MapleFish;
    ...
    protected MapleData getStringData(int itemId) {
        ...
        if (cat.equals("null")) {
            if (theData == etcStringData)
                return theData.resolve("Etc/" + String.valueOf(itemId));
            else
    ...
    public double getPrice(int itemId) {
        ...
        if (pData != null) {
            try {
                ...
                pEntry = (double) DataUtil.toInt(pData);
            }
        } else {
