...
import org.ascnet.leaftown.server.life.MobAttackInfo;
import org.ascnet.leaftown.server.life.MobAttackInfoFactory;
...
public class TakeDamageHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (damage == -1) {
            ...
            if (damagefrom == -1 && damagefrom != -2 && player.getInventory(MapleInventoryType.EQUIPPED).getItem((short) -10) != null) {
                ...
                try {
                    ...
                    for (int achilles : achillesSkillId) {
                        ...
                        if (player.getSkillLevel(achillesSkill) > 0) {
                            ...
                            final int newdamage = (int) (multiplier * damage);
                            damage = newdamage;
                            break;
                        }
                    }
