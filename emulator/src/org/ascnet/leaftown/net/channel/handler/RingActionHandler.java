...
import org.ascnet.leaftown.scripting.npc.Marriage;
...
public class RingActionHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        //c.sendPacket(org.ascnet.leaftown.tools.MaplePacketCreator.serverNotice(1, "TEST"));
        switch (mode) {
            case 0x00: //Send
                ...
                if (partnerName.equalsIgnoreCase(player.getName())) {
                    c.sendPacket(org.ascnet.leaftown.tools.MaplePacketCreator.serverNotice(1, "You cannot put your own name in it."));
                    return;
                } else if (partner == null) {
                    c.sendPacket(org.ascnet.leaftown.tools.MaplePacketCreator.serverNotice(1, partnerName + " was not found on this channel. If you are both logged in, please make sure you are in the same channel."));
                    return;
                } else if (partner.getGender() == player.getGender()) {
                    c.sendPacket(org.ascnet.leaftown.tools.MaplePacketCreator.serverNotice(1, "Your partner is the same gender as you."));
                    return;
            ...
            case 0x01: //Cancel send
                c.sendPacket(org.ascnet.leaftown.tools.MaplePacketCreator.serverNotice(1, "You've cancelled the request."));
                break;
            case 0x03: //Drop Ring
                if (player.getPartner() != null) {
                    Marriage.divorceEngagement(player, player.getPartner());
                    c.sendPacket(org.ascnet.leaftown.tools.MaplePacketCreator.serverNotice(1, "Your engagement has been broken up."));
                    break;
                } else {
