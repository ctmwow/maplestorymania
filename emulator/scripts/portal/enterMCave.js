importPackage(Packages.org.ascnet.leaftown.server.quest);
...
function enter(pi) {
	if(pi.isQuestStarted(21201)) { // Second Job
		for (var i = 108000700; i < 108000709; i++){
			...
			//pi.getPlayer().announce(Packages.org.ascnet.leaftown.tools.MaplePacketCreator.questProgress(21203, "21203"));
			return true;
		}
