...
function start() {
    ...
    } else if (actionx["3thJobI"] || (cm.getPlayer().gotPartQuestItem("JB3") && cm.getLevel() >= 70 && cm.getJobId() % 10 == 0 && parseInt(cm.getJobId() / 100) == 3 && !cm.getPlayer().gotPartQuestItem("JBP"))){
...
function action(mode, type, selection) {
 ...
 //           if (!cm.haveItem(4031012)){
  ...
  //                  if (!cm.haveItem(4031010))
            ...
            cm.sendNext("Alright, you're the " + (job == 310 ? "#bHunter#k" : "#bCrossbowman#k") + " from here on out.");
            if (cm.getJobId() != job)
