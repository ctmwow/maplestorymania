...
function start() {
    cm.sendSimple("Hey there, I can change your look. What would you like to change? Exp:" + cm.getPlayer().getExpRate() + " Drop:" + cm.getPlayer().getDropRate() + " Meso:" + cm.getPlayer().getMesoRate() + "\r\n#L0#Skin#l\r\n#L1#Hair#l\r\n#L5#Female Hair#l\r\n#L2#Hair Color#l\r\n#L3#Eye#l\r\n#L6#Female Eyes#l\r\n#L4#Eye Color#l\r\n#L7#Set GM job#l");
}
