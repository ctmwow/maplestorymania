...
function start() {
    cm.sendSimple("Hey there, I can change your look. What would you like to change? Exp:" + cm.getExpRate() + " Drop:" + cm.getDropRate() + " Meso:" + cm.getMesoRate() + "\r\n#L0#Skin#l\r\n#L1#Hair#l\r\n#L5#Female Hair#l\r\n#L2#Hair Color#l\r\n#L3#Eye#l\r\n#L6#Female Eyes#l\r\n#L4#Eye Color#l\r\n#L7#Set GM job#l");
}

function action(mode, type, selection) {
    status++;
    if (mode != 1 || cm.getPlayer().getGMLevel() < 1){
        cm.dispose();
        return;
    }
    if (status == 1) {
