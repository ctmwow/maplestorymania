...
function action(mode, type, selection) 
{
	...
	else 
	{
		...
		if (status == 0) 
		{
			...
			cm.sendSimple("Eh... So... Um... Are you trying to leave Victoria to go to a different region? You can take this boat to #bEreve#k. There, you will see bright sunlight shinning on the leaves and feel a gentle breeze on your skin. It's where Shinsoo and Empress Cygnus are. Would you like to go to Ereve? It will take about #b2 Minutes#k, and it will cost you #b100#k mesos.\r\n"+display);
		}
		else if(status == 1) 
		{
			if(cm.getMeso() < 100) 
			{
				cm.sendNext("Hmm... Are you sure you have #b100#k Mesos? Check your Inventory and make sure you have enough. You must pay the fee or I can't let you get on...");
				cm.dispose();
			} 
			else 
			{
