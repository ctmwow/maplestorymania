...
function action(mode, type, selection) {
	...
	if (cm.getPlayer().getLevel() >= 50) {
		...
		cm.sendOk("Você quer ser autorizado a fazer a Missão do Calabouço de Zakum? Bem eu, #bAdobis#k... acho que você não está pronto.  Você estará seguro andando em torno do calabouço. Apenas tenha cuidado...");
		cm.dispose();
		return;
