...
function getGroundItems() {
    var items = cm.getPlayer().getMap().getMapObjectsInRange(cm.getPlayer().getPosition(), Packages.org.ascnet.leaftown.java.lang.Double.POSITIVE_INFINITY, Packages.org.ascnet.leaftown.java.util.Arrays.asList([Packages.org.ascnet.leaftown.server.maps.MapleMapObjectType.ITEM]));
