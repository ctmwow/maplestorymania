...
function start() {
    ...
    } else if (actionx["3thJobI"] || (cm.getPlayer().gotPartQuestItem("JB3") && cm.getLevel() >= 70 && cm.getJobId() % 10 == 0 && parseInt(cm.getJobId() / 100) == 4 && !cm.getPlayer().gotPartQuestItem("JBP"))){
...
function action(mode, type, selection) {
    ...
    if (actionx["1stJob"]){
        ...
        // } else if (status == 1){
            ...
            cm.sendNext("Alright, you're the " + (job == 410 ? "#bAssasin#k" : "#bBandit#k") + " from here on out.");
            if (cm.getJobId() != job)
