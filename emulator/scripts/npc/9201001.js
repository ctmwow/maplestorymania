        ...
        if (status == 0) {
            ...
            if (selection == 1) {
                ...
                if(cm.haveItem(leaf, 1)) {
					...
					if(!cm.getPlayer().getInventory(Packages.org.ascnet.leaftown.client.inventory.MapleInventoryType.EQUIP).isFull(3)) {
                ...
                if(cm.haveItem(leaf, 1)) {
					var cheese = 2022273;
					var apple = 2022179;
					if(!cm.getPlayer().getInventory(Packages.org.ascnet.leaftown.client.inventory.MapleInventoryType.EQUIP).isFull(2)){
						cm.gainItem(apple, 3);
