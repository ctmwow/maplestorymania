...
function action(mode, type, selection) {
  ...
  //              if (selection < 3){
   ...
   //                 status -= 2;
  //              } else
                    cm.sendSimple("Please choose the job you'd like to select for your 2nd job advancement. #b\r\n#L0#Wizard (Fire / Poison)\r\n#L1#Wizard (Ice / Lighting)\r\n#L2#Cleric");
            }
         else if (status == 1){
            if (cm.haveItem(4031009)){
                cm.dispose();
            ...
            cm.sendNext("Alright, you're the " + (job == 210 ? "#bWizard (Fire / Poison)#k" : job == 220 ? "#bWizard (Ice / Lighting)#k" : "#bCleric#k") + " from here on out.");
            if (cm.getJobId() != job)
